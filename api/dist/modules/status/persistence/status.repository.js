...
let StatusRepository = class StatusRepository extends typeorm_2.Repository {
    constructor(statusRepository) {
        super(statusRepository.target, statusRepository.manager, statusRepository.queryRunner);
